...
temp <- subset(ToothGrowth, dose == 2.0 & supp == "VC")
mean(temp$len)
sd(temp$len)
...
ToothGrowth$Subjects <- 1:60

library(ez)
ezANOVA(ToothGrowth, len, wid = Subjects, between = dose)
...
#https://www.shinyapps.io/apps/RGraphCompendium/index.php
